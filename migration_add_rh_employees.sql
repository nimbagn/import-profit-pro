-- Migration: Ajout des tables pour la gestion RH complète (employés externes)
-- Date: 2025-01-XX
-- Description: Tables pour gérer le personnel sans accès à la plateforme

-- Table des employés externes
