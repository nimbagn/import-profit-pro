-- =====================================================
-- SCRIPT DE NETTOYAGE ET CONFIGURATION DE LA BASE DE DONNÉES
...
-- Supprimer aussi les anciennes tables
DROP TABLE IF EXISTS `alerts`;
DROP TABLE IF EXISTS `depot_stock`;
...
SELECT 'Base de données nettoyée et configurée avec succès!' as message;
