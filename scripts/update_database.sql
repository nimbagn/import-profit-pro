...
-- =====================================================
-- 2. CRÉATION DES TABLES AVEC STRUCTURE CORRECTE
-- =====================================================
...
CREATE TABLE `simulations` (
    ...
    CONSTRAINT `fk_simulations_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `simulation_items` (
    ...
    CONSTRAINT `fk_simulation_items_simulation` FOREIGN KEY (`simulation_id`) REFERENCES `simulations` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_simulation_items_article` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `inventories` (
    ...
    CONSTRAINT `fk_inventories_depot` FOREIGN KEY (`depot_id`) REFERENCES `depots` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
...
CREATE TABLE `inventory_items` (
    ...
    CONSTRAINT `fk_inventory_items_article` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `stock_movements` (
    ...
    CONSTRAINT `fk_stock_movements_from_depot` FOREIGN KEY (`from_depot_id`) REFERENCES `depots` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `fk_stock_movements_to_depot` FOREIGN KEY (`to_depot_id`) REFERENCES `depots` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
    CONSTRAINT `fk_stock_movements_vehicle` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE `stock_items` (
    ...
    CONSTRAINT `fk_stock_items_movement` FOREIGN KEY (`movement_id`) REFERENCES `stock_movements` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT `fk_stock_items_article` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `forecasts` (
    ...
    CONSTRAINT `fk_forecasts_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `forecast_items` (
    ...
    CONSTRAINT `fk_forecast_items_article` FOREIGN KEY (`article_id`) REFERENCES `articles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `optimization_results` (
    ...
    CONSTRAINT `fk_optimization_results_created_by` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
('manager', 'Gestionnaire', '{"read": true, "write": true, "delete": false}'),
('user', 'Utilisateur standard', '{"read": true, "write": false, "delete": false}'),
('inventory', 'Agent d\'inventaire', '{"inventory": true, "read": true}');

-- Insertion des utilisateurs
INSERT INTO `users` (`name`, `email`, `password`, `role_id`, `is_active`) VALUES
('Admin Principal', 'admin@importprofit.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeWj8QZ8QZ8QZ8QZ8', 1, TRUE),
('Gestionnaire Stock', 'manager@importprofit.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeWj8QZ8QZ8QZ8QZ8', 2, TRUE),
('Agent Inventaire', 'inventory@importprofit.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LeWj8QZ8QZ8QZ8QZ8', 4, TRUE);
