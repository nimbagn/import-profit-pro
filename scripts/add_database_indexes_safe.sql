-- Script pour ajouter les index manquants (Version sécurisée avec gestion des erreurs)
-- Exécuter avec: mysql -u root -p madargn < scripts/add_database_indexes_safe.sql
-- 
-- Ce script ignore les erreurs "Duplicate key name" (index déjà existants)
